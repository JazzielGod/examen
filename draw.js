...
function draw() {
    ...
    // La Paz
    drawClockLaPaz(150, height / 2, horaLaPaz, minutoLaPaz, segundoLaPaz);

    // Ciudad de México
    let horaCDMX = (horaLaPaz - 1 + 24) % 24;
    // drawClockCDMX(400, height / 2, horaCDMX, minutoLaPaz, segundoLaPaz);

    // Barcelona
    let horaBarcelona = (horaLaPaz + 8 + 24) % 24;
    // drawClockBarcelona(650, height / 2, horaBarcelona, minutoLaPaz, segundoLaPaz);
}